...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', '../assets/images/vfes-logo-white.svg');
}
...
// preset header background color
document.addEventListener('DOMContentLoaded', function () {
  var if_exist_header_bg = document.querySelectorAll('.preset-header-bg-color');
  if (if_exist_header_bg) {
    var preset_color_header_bg = document.querySelectorAll('.preset-header-bg-color > a');
    for (var h = 0; h < preset_color_header_bg.length; h++) {
      var c = preset_color_header_bg[h];
      c.addEventListener('click', function (event) {
        var targetElementHeaderBg = event.target;
        if (targetElementHeaderBg.tagName == 'SPAN') {
          targetElementHeaderBg = targetElementHeaderBg.parentNode;
        }
        var temp_header_bg = targetElementHeaderBg.getAttribute('data-value');
        preset_change_header_bg(temp_header_bg);
      });
    }
  }
  // if (document.querySelector('.pct-body')) {
  ...
  var layout_reset_header_bg = document.querySelector('#layoutreset');
  if (layout_reset_header_bg) {
    layout_reset_header_bg.addEventListener('click', function (e) {
      location.reload();
    });
  }
});
...
function preset_change_header_bg(value) {
  document.getElementsByTagName('header')[0].setAttribute('data-pc-preset', value);
  var control_header_bg = document.querySelector('.preset-header-bg-color');
  if (control_header_bg) {
    document.querySelector('.preset-header-bg-color > a.active').classList.remove('active');
    document.querySelector(".preset-header-bg-color > a[data-value='" + value + "']").classList.add('active');
  }
}
...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../assets/images/vfes-logo-white.svg');
    }

    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '../assets/images/vfes-logo-white.svg');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '../assets/images/vfes-logo-white.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '../assets/images/vfes-logo-white.svg');
    }
    ...
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '../assets/images/vfes-logo.svg');
    }
    if (document.querySelector('.auth-main.v1 .auth-sidefooter')) {
      document.querySelector('.auth-main.v1 .auth-sidefooter img').setAttribute('src', '../assets/images/vfes-logo.svg');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '../assets/images/vfes-logo.svg');
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
      document.querySelector('.theme-layout .btn.active').classList.remove('active');
