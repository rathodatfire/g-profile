...
<html lang="en">
  ...
  <head>
    <title>Home | VFES Dashboard Template</title>
    <!-- [Meta] -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="VFES is trending dashboard template made using Bootstrap 5 design framework. VFES is available in Bootstrap, React, CodeIgniter, Angular,  and .net Technologies.">
    <meta name="keywords" content="Bootstrap admin template, Dashboard UI Kit, Dashboard Template, Backend Panel, react dashboard, angular dashboard">
    <meta name="author" content="VFES">
  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="../dashboard/index.html" class="b-brand text-primary">
        ...
        <img src="../assets/images/vfes-logo-white.svg" class="img-fluid logo-lg" alt="logo">
        ...
        <div class="card-body">
          <div class="d-flex align-items-center">
            <div class="flex-shrink-0">
              <img src="{{ asset('public/assets/images/user/avatar-1.jpg')}}" alt="user-image" class="user-avtar wid-45 rounded-circle" />
            </div>
      ...
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            ...
            <li class="pc-item"><a class="pc-link" href="../demo/layout-2.html">Layouts 2</a></li>
        ...
        <li class="pc-item pc-hasmenu">
          ...
          ></a>
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="../application/invoice.html">Dashboard</a></li>
            <li class="pc-item"><a class="pc-link" href="../application/invoice-create.html">Create</a></li>
            <li class="pc-item"><a class="pc-link" href="../application/invoice-view.html">Details</a></li>
            <li class="pc-item"><a class="pc-link" href="../application/invoice-list.html">List</a></li>
            <li class="pc-item"><a class="pc-link" href="../application/invoice-edit.html">Edit</a></li>
          </ul>
        </li>
        <li class="pc-item">
...
<!-- [ Sidebar Menu ] end --> <!-- [ Header Topbar ] start -->
  {{--  @include('partials.header-dash-nav') --}}
<!-- [ Header ] end -->
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1 ms-3">
                    <h6 class="mb-0">VFES</h6>
                    <small class="text-muted">@vfesdevelop</small>
                  </div>
                  <div class="dropdown">
                    <a
                      class="avtar avtar-s btn-link-secondary dropdown-toggle arrow-none"
                        ...
                        <div class="flex-grow-1 ms-3">
                          <div class="row g-1">
                            <div class="col-6">
                              ...
                              <p class="text-muted mb-0"><small>#VFES-T00232</small></p>
                            </div>
                        ...
                        <div class="flex-grow-1 ms-3">
                          <div class="row g-1">
                            <div class="col-6">
                              ...
                              <p class="text-muted mb-0"><small>#VFES-T10232</small></p>
                            </div>
                            <div class="col-6 text-end">
    ...
    <footer class="pc-footer">
      <div class="footer-wrapper container-fluid">
        <div class="row">
          <div class="col my-1">
            <p class="m-0">© 2024 VFES. All Rights Reserved.</p>
          </div>
          <div class="col-auto my-1">
            <ul class="list-inline footer-link mb-0">
              <li class="list-inline-item"><a href="index.html">Home</a></li>
              <li class="list-inline-item"><a href="javascript:void(0)" target="_blank">Documentation</a></li>
              <li class="list-inline-item"><a href="javascript:void(0)" target="_blank">Support</a></li>
            </ul>
          </div>
        </div>
      </div>
